...
export const gridItems = [
  {
    id: 1,
    title: "Currently working in TCS ",
    description:
...

  {
    ...
    description: "Last Project - Machine Learning",
    className: "md:col-span-3 md:row-span-2",
    imgClassName: "absolute right-0 bottom-0 md:w-96 w-60",
    titleClassName: "justify-center md:justify-start lg:justify-center",
    img: "/visual_data.svg",
    spareImg: "./src/assets/grid.svg",
  },
  {
    id: 6,
...
export const projects = [
  {
    id: 1,
    title: "Blogging Site for Coders",
  ...
  {
    id: 3,
    title: "LLM Chatbot for Credit Cards",
